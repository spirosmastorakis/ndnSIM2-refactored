...
def build(bld):
    ...
    bld(features="cxx",
        ...
        use=['version-ndn-cxx', 'BOOST', 'CRYPTOPP', 'SQLITE3', 'RT', 'PTHREAD', 'cxxshlib'],
        includes=['../..', "../../ns3/ndnSIM", "../../ns3/ndnSIM/ndn-cxx"],
        export_includes=["../../ns3/ndnSIM"]
    )

    module_dirs = ['NFD/core', 'NFD/daemon']
    bld(features="cxx",
        target="NFD",
        name="NFD",
        ...
        use=['version-NFD', 'ndn-cxx', 'cxxshlib'],
        includes=['../..', '../../ns3/ndnSIM/NFD', "./NFD/core", "./NFD/daemon"],
